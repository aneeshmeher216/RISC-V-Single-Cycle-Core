...
HD_PWD='E:/Electronics/Verilog Projects/RISC-V_Single_Cycle_Core/RISC-V.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Single_Cycle_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Single_Cycle_top.tcl
